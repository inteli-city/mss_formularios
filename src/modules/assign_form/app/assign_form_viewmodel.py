...
from src.shared.helpers.contracts.endpoints.assign_form_contract import AssignFormResponseSchema
...
class AssignFormViewmodel:
    ...
    def to_dict(self) -> dict:
        ...
        return AssignFormResponseSchema.model_validate(payload).model_dump()
