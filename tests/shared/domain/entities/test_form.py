...
class Test_Form:
    ...
    def test_priority_not_enum(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority='PRIORITY.EMERGENCY', status=FORM_STATUS.IN_PROGRESS, expiration_date=946407600000, creation_date=946407600000, start_date=946407600000, conclusion_date=None, justification=justification, comments='comments', sections=[section, section], information_fields=None)
    ...
    def test_expiration_date_not_int(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority=PRIORITY.EMERGENCY, status=FORM_STATUS.IN_PROGRESS, expiration_date='946407600000', creation_date=946407600000, start_date=None, conclusion_date=None, justification=justification, comments='comments', sections=[section, section], information_fields=None)
    ...
    def test_start_date_status_in_progress_not_none(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority=PRIORITY.EMERGENCY, status=FORM_STATUS.IN_PROGRESS, expiration_date=946407600000, creation_date=946407600000, start_date=None, conclusion_date=946407600000, justification=justification, comments='comments', sections=[section, section], information_fields=None)
    ...
    def test_justification_not_str(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority=PRIORITY.EMERGENCY, status=FORM_STATUS.IN_PROGRESS, expiration_date=946407600000, creation_date=946407600000, start_date=946407600000, conclusion_date=946407600000, justification=99999, comments='comments', sections=[section, section], information_fields=None)
    
    def test_comments_not_str(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority=PRIORITY.EMERGENCY, status=FORM_STATUS.IN_PROGRESS, expiration_date=946407600000, creation_date=946407600000, start_date=946407600000, conclusion_date=946407600000, justification=justification, comments=99999, sections=[section, section], information_fields=None)
    
    def test_sections_not_list(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority=PRIORITY.EMERGENCY, status=FORM_STATUS.IN_PROGRESS, expiration_date=946407600000, creation_date=946407600000, start_date=946407600000, conclusion_date=946407600000, justification=justification, comments='comments', sections=section, information_fields=None)
    
    def test_sections_is_empty(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority=PRIORITY.EMERGENCY, status=FORM_STATUS.IN_PROGRESS, expiration_date=946407600000, creation_date=946407600000, start_date=946407600000, conclusion_date=946407600000, justification=justification, comments='comments', sections=[], information_fields=None)
    ...
    def test_information_fields_not_list(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority=PRIORITY.EMERGENCY, status=FORM_STATUS.IN_PROGRESS, expiration_date=946407600000, creation_date=946407600000, start_date=946407600000, conclusion_date=946407600000, justification=justification, comments='comments', sections=[section, section], information_fields=information_field)
    
    def test_information_fields_is_empty(self):
        with pytest.raises(EntityError):
            Form(form_title='form_title', form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', creator_user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', user_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', vinculation_form_id='d61dbf66-a10f-11ed-a8fc-0242ac120001', can_vinculate=True, template='template', area='area', system='system', street='street', city='city', number=99999, latitude=99999.99, longitude=99999.99, region='region', description='description', priority=PRIORITY.EMERGENCY, status=FORM_STATUS.IN_PROGRESS, expiration_date=946407600000, creation_date=946407600000, start_date=946407600000, conclusion_date=946407600000, justification=justification, comments='comments', sections=[section, section], information_fields=[])