from src.modules.cancel_form.app.cancel_form_viewmodel import CancelFormViewmodel, FieldViewmodel, FormViewmodel, InformationFieldViewmodel, JustificationOptionViewmodel, JustificationViewmodel, SectionViewmodel
...
class Test_CancelFormViewmodel:
