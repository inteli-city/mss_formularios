...
class FormDynamoDTO:
    ...
    def from_dynamo(data: dict) -> "FormDynamoDTO":
        return FormDynamoDTO(
            ...
            expiration_date=int(data['expiration_date']),
            creation_date=int(data['creation_date']) ,
            start_date=int(data['start_date']) if data['start_date'] else None,
            conclusion_date=int(data['conclusion_date']) if data['conclusion_date'] else None,
