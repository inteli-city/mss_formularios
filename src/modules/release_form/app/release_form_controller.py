...
from .release_form_viewmodel import ReleaseFormViewmodel
from src.shared.helpers.contracts.runtime_requests import ReleaseFormControllerRequestSchema
...
class ReleaseFormController:
    def __init__(self, usecase: ReleaseFormUsecase):
    ...
    def __call__(self, request: IRequest) -> IResponse:
        try:
            ...
            payload = ReleaseFormControllerRequestSchema.model_validate(data)
            ...
            viewmodel = ReleaseFormViewmodel(form)
