...
from .claim_form_usecase import ClaimFormUsecase
from .claim_form_viewmodel import ClaimFormViewmodel
from src.shared.helpers.contracts.runtime_requests import ClaimFormControllerRequestSchema
...
class ClaimFormController:
    def __init__(self, usecase: ClaimFormUsecase):
    ...
    def __call__(self, request: IRequest) -> IResponse:
        try:
            ...
            payload = ClaimFormControllerRequestSchema.model_validate(data)
            ...
            viewmodel = ClaimFormViewmodel(form)
